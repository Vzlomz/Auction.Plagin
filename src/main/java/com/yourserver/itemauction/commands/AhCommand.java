...
public class AhCommand implements CommandExecutor {
    ...
    private void sendHelp(Player player) {
        ...
        player.sendMessage("§7 3. Нажми на слот §f\"Указать цену\"§7 (справа) - откроется выбор раздела");
        player.sendMessage("§7 4. Выбери раздел (Блоки, Инструменты, Броня, Еда, Ресурсы) или \"Все предметы\"");
        player.sendMessage("§7 5. Найди нужный предмет (можно листать страницы) и кликни по нему");
        player.sendMessage("§7 6. Если предмет можно зачаровать - появится список чар для него,");
        player.sendMessage("§7    выбери чару и уровень (или нажми §f\"Без чар\"§7, если неважно)");
        player.sendMessage("§7 7. На следующем окне подбери количество кнопками -64/-10/-1/+1/+10/+64");
        player.sendMessage("§7    (этот предмет у тебя быть не обязан - это просто условие для покупателя)");
        player.sendMessage("§7 8. Нажми §f\"Готово\"§7, затем на зелёное стекло §f\"Подтвердить\"§7 - лот опубликован");
