...
public class MaterialPickerHolder implements InventoryHolder {
    ...
    private final MaterialCatalog.Category category;
    private final int page;
    private final List<Material> pageMaterials;
    private final boolean hasNextPage;

    public MaterialPickerHolder(MaterialCatalog.Category category, int page, List<Material> pageMaterials, boolean hasNextPage) {
    ...
    public MaterialCatalog.Category getCategory() {
        return category;
    }
